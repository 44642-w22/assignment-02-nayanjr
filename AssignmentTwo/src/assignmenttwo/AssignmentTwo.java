  ...
  System.out.println(output);
   ...
   System.out.println(firstLast(list,scan));
	...
	public static void stringOccurence (String A [],Scanner scan)
	{
		...
		System.out.println("Please enter no of elements(Problem01):");
	...
	{    
		System.out.println("\nPlease enter no of Strings(Problem02)");
		int size = scan.nextInt();
		S1= new String[size];
	...
	public static Set<Integer> arraytoSet (int A1 [], Scanner scan)
	{
		...
		System.out.println("\nPlease enter no of elements(Problem03)");
		int size = scan.nextInt();
		A1= new int[size];
		System.out.println("Please enter elements");
		for (int i = 0; i < size; i++) {
	...
	{
		System.out.println("\nPlease enter no of Strings(Problem04)");
		int size = scan.nextInt();
	...
	{
		System.out.println("\nEnter the no of strings(Problem05):");
		int size = scan.nextInt();
	...
	public static Map <String,Boolean> findKey(ArrayList<String> list2,Scanner scan)
	{
		...
		System.out.println("\nEnter the no of strings(Problem06):");
		int size = scan.nextInt();
